 ...
 export default function Fruits(){
    return(
        ...
        <div className="flex flex-col gap-2 bg-[#FF8989] rounded-md md:flex-row">
          <img src='https://picsum.photos/id/1080/200/200' className="rounded-md" alt="Strawberry"/>
          <div>
        ...
        <div className="flex flex-col gap-2 bg-[#FF8989] rounded-md md:flex-row" >
        <img src='https://picsum.photos/id/766/200/200' className="rounded-md" alt="Coffee"/>
         <div>
        ...
        <div className="flex flex-col gap-2 bg-[#FF8989] rounded-md md:flex-row">
        <img src='https://picsum.photos/id/674/200/200' className="rounded-md" alt="Grapes"/>
          <div>
        ...
        <div className="flex flex-col gap-2 bg-[#FF8989] rounded-md md:flex-row">
        <img src='https://picsum.photos/id/429/200/200' className="rounded-md" alt="Raspberry"/>
           <div>
        ...
        <div className="flex flex-col gap-2 bg-[#FF8989] rounded-md md:flex-row">
        <img src='https://picsum.photos/id/824/200/200' className="rounded-md" alt="Pineapple"/>
         <div>
        ...
        <div className="flex flex-col gap-2 bg-[#FF8989] rounded-md md:flex-row">
        <img src='https://picsum.photos/id/517/200/200' className="rounded-md" alt="Orange"/>
         <div>
